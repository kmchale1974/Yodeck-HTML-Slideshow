...
ADMIN_DIR="_Yodeck-HTML-Slideshow_FirePrevention/images"
RUNTIME_DIR="_Yodeck-HTML-Slideshow_FirePrevention_Runtime/images"
...
echo "Runtime media build complete (FirePrevention)."
