...
ADMIN_DIR="_Yodeck-HTML-Slideshow_PublicWorksAdmin/images"
RUNTIME_DIR="_Yodeck-HTML-Slideshow_PublicWorksAdmin_Runtime/images"
...
echo "Runtime media build complete (PublicWorksAdmin)."
