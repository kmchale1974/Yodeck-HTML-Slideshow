...
ADMIN_DIR="_Yodeck-HTML-Slideshow_AquaticCenter/images"
RUNTIME_DIR="_Yodeck-HTML-Slideshow_AquaticCenter_Runtime/images"
...
echo "Runtime media build complete (AquaticCenter)."
